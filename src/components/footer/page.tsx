            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
              <div>
                ...
                <ul className="flex gap-6 mt-8">
                  ...
                  <li>
                    <Link href="https://github.com" rel="noreferrer" target="_blank" className="transition hover:opacity-75">
                  ...
                  <li>
                    <Link href="https://www.youtube.com/@MEF.TTDVporto" rel="noreferrer" target="_blank" className=" transition hover:opacity-75">
